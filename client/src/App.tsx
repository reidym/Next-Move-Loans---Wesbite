...
function RouteLoading(){return <div aria-live="polite" className="grid min-h-[100svh] place-items-center bg-white px-6 text-[#16203A]" role="status"><div className="text-center"><p className="text-2xl font-black">Next Move Loans</p><div aria-hidden="true" className="mx-auto mt-5 h-0.5 w-24 overflow-hidden bg-[#16203A]/12"><span className="block h-full w-1/2 animate-pulse bg-[#EC7354]"/></div></div></div>}
