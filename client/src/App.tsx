/**
 * Pathfinder Editorial routing map: a concise public navigation layer backed by scalable,
 * data-driven service, article and location templates with clear escape routes on every page.
 */
...
const LOADER_LOGO = "/manus-storage/nextmove-hori-480_bef5fab9.webp";
...
const Contact = lazy(() => import("@/pages/ConversionPages").then((module) => ({ default: module.Contact })));
...
function RouteLoading() {
  return (
    <div aria-live="polite" className="grid min-h-[100svh] place-items-center bg-[#F7F5F1] px-6 text-[#16203A]" role="status">
      <div className="text-center">
        <img alt="Next Move Loans" className="mx-auto h-auto w-48" decoding="async" height="305" src={LOADER_LOGO} width="1200" />
        <div aria-hidden="true" className="mx-auto mt-7 h-0.5 w-28 overflow-hidden bg-[#16203A]/12">
          <span className="block h-full w-1/2 animate-pulse bg-[#EC7354]" />
        </div>
        <p className="mt-4 text-xs font-bold uppercase tracking-[0.18em] text-[#4C5566]">Mapping the next route</p>
      </div>
    </div>
  );
}
  ...
  return (
    <Suspense fallback={<RouteLoading />}>
      <Switch>
        ...
        <Route path="/approval-method" component={ApprovalMethod} />
        <Route path="/about" component={About} />
        <Route path="/team/martin-reidy" component={Founder} />
        <Route path="/team" component={Team} />
        <Route path="/reviews" component={Reviews} />
        <Route path="/contact" component={Contact} />
        <Route path="/plan-your-next-move" component={PlanYourMove} />
        ...
        <Route path="/finance/:category" component={CategoryPage} />
        <Route path="/services/:slug" component={ServicePage} />
        <Route path="/learn" component={Learning} />
        <Route path="/learn/topics/:slug" component={TopicHubPage} />
        <Route path="/learn/:slug" component={ArticlePage} />
        <Route path="/locations" component={Locations} />
        <Route path="/locations/:slug" component={LocationPage} />
        <Route path="/calculators" component={Calculators} />
        <Route path="/important-information" component={ImportantInformation} />
        <Route path="/privacy" component={Privacy} />
        <Route path="/credit-guide" component={CreditGuide} />
