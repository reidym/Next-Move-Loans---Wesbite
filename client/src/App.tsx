...
function RouteLoading(){return <div aria-live="polite" className="grid min-h-[100svh] place-items-center bg-[#F7F5F1] px-6 text-[#16203A]" role="status"><div className="text-center"><img alt="Next Move Loans" className="mx-auto h-auto w-48" src={LOADER_LOGO}/><div aria-hidden="true" className="mx-auto mt-7 h-0.5 w-28 overflow-hidden bg-[#16203A]/12"><span className="block h-full w-1/2 animate-pulse bg-[#EC7354]"/></div><p className="mt-4 text-xs font-bold uppercase tracking-[0.18em] text-[#4C5566]">Mapping the next route</p></div></div>}
